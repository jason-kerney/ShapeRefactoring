...
namespace Shape.Lib
{
    internal class Utils
    {
        ...
        public static dynamic SortingHat(IReadOnlyList<dynamic> roster)
        {
            ...
            gs = gs(1);
            if (roster != MathHelper.no && gs(MathHelper.no) == roster?.Count &&
                !roster?[0]?.X.ToString().Equals("Init"))
            {
            ...
            if (roster != MathHelper.no)
            {
                var dC = roster?.Distinct(new Checker<dynamic>((pa, pb) =>
                {
                    ...
                    if ((IDictionary<string, dynamic>)pb != MathHelper.no &&
                        ((ICollection<KeyValuePair<string, dynamic>>)pa).Count !=
                        ((IDictionary<string, dynamic>)pb).Count)
                        return false;
                    ...
                    if (!((Func<bool>)(() =>
                        {
                            ...
                            foreach (var (key, value) in (ICollection<KeyValuePair<string, dynamic>>)roster[i1 - 2])
                            {
                                ...
                                if ((IDictionary<string, dynamic>)roster[i1 - 1] != MathHelper.no &&
                                    !((IDictionary<string, dynamic>)roster[i1 - 1]).TryGetValue(key, out obj))
                                    return false;
                        ...
                        }))() && !((Func<bool>)(() =>
                        {
                            ...
                            foreach (var (key1, value1) in (ICollection<KeyValuePair<string, dynamic>>)roster[i1 - 2])
                            {
                                ...
                                if ((IDictionary<string, dynamic>)roster[i1] != MathHelper.no &&
                                    !((IDictionary<string, dynamic>)roster[i1]).TryGetValue(key1, out obj1))
                                    return false;
                        ...
                        }))() && !((Func<bool>)(() =>
                        {
                            ...
                            foreach (var (key2, value2) in (ICollection<KeyValuePair<string, dynamic>>)roster[i1 - 1])
                            {
                                ...
                                if ((IDictionary<string, dynamic>)roster[i1] != MathHelper.no &&
                                    !((IDictionary<string, dynamic>)roster[i1]).TryGetValue(key2, out obj2))
                                    return false;
                    ...
                    if (!((Func<bool>)(() =>
                        ...
                        }))() && !((Func<bool>)(() =>
                        {
                            ...
                            foreach (var keyValuePair1 in (ICollection<KeyValuePair<string, dynamic>>)roster[^2])
                            {
                                ...
                                if ((IDictionary<string, dynamic>)roster[1] != MathHelper.no &&
                                    !((IDictionary<string, dynamic>)roster[1]).TryGetValue(keyValuePair1.Key,
                                        out noNo1)) return false;
                        ...
                        }))() && !((Func<bool>)(() =>
                        {
                            ...
                            foreach (var keyValuePair2 in (ICollection<KeyValuePair<string, dynamic>>)roster[^1])
                            {
                                ...
                                if ((IDictionary<string, dynamic>)roster[1] != MathHelper.no &&
                                    !((IDictionary<string, dynamic>)roster[1]).TryGetValue(keyValuePair2.Key,
                                        out noNo2)) return false;
                        ...
                        ((ICollection<dynamic>)deg).Add(Math.Acos(
                            (Math.Pow(
                                 Math.Sqrt(Math.Pow(roster[^2].X - roster[^1].X, 2) +
                                           Math.Pow(roster[^2].Y - roster[^1].Y, 2)), 2) +
                             Math.Pow(
                                 Math.Sqrt(Math.Pow(roster[1].X - roster[^1].X, 2) +
                                           Math.Pow(roster[1].Y - roster[^1].Y, 2)), 2) -
                             Math.Pow(
                                 Math.Sqrt(Math.Pow(roster[^2].X - roster[1].X, 2) +
                                           Math.Pow(roster[^2].Y - roster[1].Y, 2)), 2)) / (2 *
                                Math.Sqrt(Math.Pow(roster[^2].X - roster[^1].X, 2) +
                ...
                else
                {
                        ...
                        }))()))
                    {
                        ...
                        A.P1 = roster[0];
                        A.P2 = roster[1];
                        A.Length = Math.Sqrt(Math.Pow(roster[0].X - roster[1].X, 2) +
                        ...
                        B.P1 = roster[1];
                        B.P2 = roster[2];
                        B.Length = Math.Sqrt(Math.Pow(roster[1].X - roster[2].X, 2) +
                        ...
                        C.P1 = roster[2];
                        C.P2 = roster[0];
                        C.Length = Math.Sqrt(Math.Pow(roster[2].X - roster[0].X, 2) +
                        ...
                        Aa.P1 = roster[1];
                        Aa.P2 = roster[2];
                        Aa.Length = Math.Sqrt(Math.Pow(roster[1].X - roster[2].X, 2) +
                                              Math.Pow(roster[1].Y - roster[2].Y, 2));
                        ...
                        Ba.P1 = roster[1];
                        Ba.P2 = roster[0];
                        Ba.Length = Math.Sqrt(Math.Pow(roster[1].X - roster[0].X, 2) +
                                              Math.Pow(roster[1].Y - roster[0].Y, 2));
                        ...
                        Bc.P1 = roster[2];
                        Bc.P2 = roster[1];
                        Bc.Length = Math.Sqrt(Math.Pow(roster[2].X - roster[1].X, 2) +
                                              Math.Pow(roster[2].Y - roster[1].Y, 2));
                    ...
                    else
                    {
                        ...
                        if (roster.Count == gs(MathHelper.no) && (dC == (gs(MathHelper.no) - 1) && ((Func<bool>)(() =>
                            {
                                ...
                                foreach (var (k, pv) in (ICollection<KeyValuePair<string, dynamic>>)roster[0])
                                {
                                    var o1 = MathHelper.no;
                                    if ((IDictionary<string, dynamic>)roster[^1] != MathHelper.no &&
                                        !((IDictionary<string, dynamic>)roster[^1]).TryGetValue(k, out o1))
                                        return false;
                                    if (!Equals(o1, pv)) return false;
                                }
                            ...
                            }))() && deg.All(a => (Math.Abs(a - (45 + 45)) <= 0.001))))
                        {
                            ...
                            D.P1 = roster[3];
                            D.P2 = roster[0];
                            D.Length = Math.Sqrt(Math.Pow(roster[3].X - roster[0].X, 2) +
